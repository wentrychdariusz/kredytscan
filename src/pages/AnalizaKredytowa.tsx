...
const AnalizaKredytowa = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-white via-warm-neutral-50 to-business-blue-50">
      ...
      {/* Logo Header */}
      <header className="pt-4 pb-3 px-4 bg-gradient-to-b from-navy-900 via-navy-800 to-navy-900 border-b border-navy-700/50">
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-3 md:gap-6">
          ...
          <div className="text-right flex-1">
            <h2 className="font-montserrat text-xs md:text-lg lg:text-xl xl:text-2xl font-bold text-white leading-tight">
              Bank odmówił Ci kredytu?<br />
              <span className="text-prestige-gold-400">Dowiedz się, co Cię blokuje i jak to naprawić.</span>
            </h2>
          </div>
        </div>
      </header>
